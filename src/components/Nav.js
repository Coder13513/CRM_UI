            ...
            <Router>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm-10" >
                            {/* <nav class="navbar navbar-expand-sm navbar-fixed-top navbar-inverse bg-inverse main-nav">
    <div class="container">
...
{/* </div> */}
                            ...
                            <ul class="navbar-nav">
                                ...
                                {/* <ul class="navbar-nav abs-center-x">
            <li class="nav-item"><a class="maintitle" href="#">CRM</a></li>
            <li class="nav-item"><a class="maintitle" href="#">Dashboard</a></li>
        </ul> */}
